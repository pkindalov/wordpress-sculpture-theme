 ...
 * 
 * Overrides parent Astra theme footer
 * 
    ...
    <div class="footer-main">
        <div class="footer-container">
            ...
            <div class="footer-column footer-about">
                <h3 class="footer-title"><?php echo $about_artist_title; ?></h3>
                <p class="footer-text"><?php echo $artist_short_description; ?></p>
                <div class="footer-social">
                    <a href="https://instagram.com/yourhandle" target="_blank" rel="noopener" class="social-link" aria-label="Instagram">
                    ...
                    <a href="https://facebook.com/yourpage" target="_blank" rel="noopener" class="social-link" aria-label="Facebook">
                        <svg width="24" height="24" fill="currentColor" viewBox="0 0 16 16">
                            <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z" />
                        </svg>
                    </a>

                    <a href="<?php echo esc_url('mailto:' . antispambot($contact_email)); ?>" class="social-link" aria-label="Email">
                        <svg width="24" height="24" fill="currentColor" viewBox="0 0 16 16">
            ...
            <div class="footer-column footer-contact">
                <h3 class="footer-title"><?php echo $get_in_touch_label; ?></h3>
