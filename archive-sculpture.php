...
$filters = [
    ...
    'materials' => isset($_GET['materials']) ? sanitize_text_field($_GET['materials']) : '',
    ...
    'price_min' => isset($_GET['price_min']) && $_GET['price_min'] !== '' ? intval($_GET['price_min']) : '',
    'price_max' => isset($_GET['price_max']) && $_GET['price_max'] !== '' ? intval($_GET['price_max']) : '',
    'year_min' => isset($_GET['year_min']) && $_GET['year_min'] !== '' ? intval($_GET['year_min']) : '',
    'year_max' => isset($_GET['year_max']) && $_GET['year_max'] !== '' ? intval($_GET['year_max']) : '',
...
$gallery_title = sculpture_translate('Sculpture Gallery', 'common');
$gallery_subtitle = sculpture_translate('Explore our collection of original artworks', 'common');
$sculptures_found_label = sculpture_translate('sculptures found', 'common');
$no_sculptures_title = sculpture_translate('No sculptures found', 'common');
$no_sculptures_text = sculpture_translate('Try adjusting your filters to see more results', 'common');
$clear_filters_label = sculpture_translate('Clear All', 'buttons');
$back_to_home_label = sculpture_translate('Back to Home', 'buttons');
?>
...
<div class="sculpture-archive">
    ...
    <header class="archive-header">
        <h1 class="archive-title"><?php echo $gallery_title; ?></h1>
        <p class="archive-subtitle"><?php echo $gallery_subtitle; ?></p>
    </header>
    ...
    <?php if ($sculptures->have_posts()): ?>
        <div class="results-info-modern">
            <span class="results-count"><?php echo esc_html($sculptures->found_posts); ?></span>
            <span class="results-text"><?php echo $sculptures_found_label; ?></span>
        </div>
    <?php endif; ?>
    ...
    <?php else: ?>
        ...
        <div class="no-sculptures-modern">
            ...
            <h3><?php echo $no_sculptures_title; ?></h3>
            <p><?php echo $no_sculptures_text; ?></p>
            <a href="<?php echo esc_url(get_post_type_archive_link('sculpture')); ?>" class="btn-clear-filters">
                <?php echo $clear_filters_label; ?>
            </a>
        </div>
