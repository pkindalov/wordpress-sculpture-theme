...
$filter_data = isset($args['filter_data']) ? $args['filter_data'] : array();
?>
    ...
    <form method="GET" action="<?php echo esc_url(get_post_type_archive_link('sculpture')); ?>" class="filters-form-modern">
        ...
        <div class="filters-compact-bar">
            ...
            <div class="filter-search-modern">
                ...
                <input type="text" name="search_query" placeholder="Search sculptures..." value="<?php echo esc_attr($filters['search']); ?>" class="search-input-modern">
            </div>
            
            <!-- Sort -->
            <div class="filter-sort-modern">
                <select name="orderby" class="sort-select-modern" onchange="this.form.submit()">
                    <option value="date" <?php selected($filters['orderby'], 'date'); ?>>Latest</option>
                    <option value="title" <?php selected($filters['orderby'], 'title'); ?>>A-Z</option>
                    <option value="year" <?php selected($filters['orderby'], 'year'); ?>>Newest Year</option>
                    <option value="price_low" <?php selected($filters['orderby'], 'price_low'); ?>>Price: Low</option>
                    <option value="price_high" <?php selected($filters['orderby'], 'price_high'); ?>>Price: High</option>
                </select>
            </div>
                ...
                <div class="slider-group">
                    <div class="slider-header">
                        ...
                        <span class="slider-value" id="priceValue">
                            €<?php echo $filters['price_min'] ?: $filter_data['min_price']; ?> - 
                            €<?php echo $filters['price_max'] ?: $filter_data['max_price']; ?>
                        </span>
                    </div>
                ...
                <div class="slider-group">
                    <div class="slider-header">
                        ...
                        <span class="slider-value" id="yearValue">
                            <?php echo $filters['year_min'] ?: $filter_data['min_year']; ?> - 
                            <?php echo $filters['year_max'] ?: $filter_data['max_year']; ?>
                        </span>
                    </div>
                    <div class="dual-slider">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (toggleBtn && panel) {
        const hasFilters = <?php 
            echo ($filters['availability'] || $filters['materials'] || $filters['price_min'] || $filters['price_max'] || $filters['year_min'] || $filters['year_max']) ? 'true' : 'false'; 
        ?>;
