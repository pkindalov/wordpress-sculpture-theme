...
$original_label = sculpture_translate('Original', 'common');
$read_more_label = sculpture_translate('Read More', 'buttons');
?>
<article class="publication-card publication-type-<?php echo esc_attr($article_type); ?>">
    ...
    <div class="card-content">
        ...
        <!-- Type Badge -->
        <span class="publication-type-badge"><?php echo esc_html($type_label); ?></span>
        ...
        <div class="card-footer">
            ...
            <?php if ($external_url): ?>
            <a href="<?php echo esc_url($external_url); ?>" class="external-link" target="_blank" rel="noopener">
